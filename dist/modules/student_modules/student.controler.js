...
const createStudent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const zodValidatedStudent =
        student_validation_1.studentZodSchema.parse(student);
      const result = yield student_services_1.studentServices.createStudent(
        zodValidatedStudent
      );
      res.status(200).json({
        success: true,
...
const getSingleStudent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const result = yield student_services_1.studentServices.getSigleStudent(
        id
      );
      res.status(200).json({
        success: true,
...
const deleteStudent = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const result = yield student_services_1.studentServices.deleteStudent(
        deletedID
      );
      res.status(200).json({
        success: true,
